          ...
          {!sidebarCollapsed ? (
            <div className="flex items-center gap-3 flex-1">
              <button
                type="button"
                onClick={() => setMobileMenuOpen(false)}
                className="lg:hidden p-1 -ml-1 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100"
              >
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6">
          ...
          {currentView === 'persons' && (
            <button
              ...
              className="flex items-center gap-2 px-3 lg:px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition active:bg-gray-700 touch-manipulation"
            >
          ...
          {showPersons && (
                <div className="bg-white rounded-lg border border-gray-200">
                  <div className="p-4 border-b border-gray-200">
                    <h2 className="text-sm lg:text-base font-semibold text-gray-900">Personas registradas</h2>
                  </div>
                ...
                <div className="space-y-2">
                      ...
                      onKeyDown={(event) => {
                        if (event.key === 'Enter' || event.key === ' ') {
                          ...
                          setRegisterMessage(null);
                            ...
                            className={`w-full text-left rounded-lg border px-3 lg:px-4 py-3 cursor-pointer transition touch-manipulation ${
                        selectedPersonId === person.id
                                ? 'border-gray-900 bg-gray-50'
                                : 'border-gray-200 active:bg-gray-50 lg:hover:border-gray-300 lg:hover:bg-gray-50'
                  ...
                  {personsVisibleCount < persons.length && (
                    <button
                      ...
                      className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-700 active:bg-gray-50 lg:hover:bg-gray-50 transition touch-manipulation"
                    >
                      Cargar más
                    </button>
                  )}
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4 lg:p-6">
                    ...
                    <div className="space-y-2 lg:space-y-3">
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg border border-gray-300 text-sm font-medium text-gray-700 active:bg-gray-50 lg:hover:bg-gray-50 transition touch-manipulation"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg border border-red-300 text-sm font-medium text-red-700 active:bg-red-50 lg:hover:bg-red-50 transition touch-manipulation"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {(() => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg border text-sm font-medium transition touch-manipulation ${
                              selectedPerson.active
                                ? canDisable
                                  ? 'border-yellow-300 text-yellow-700 active:bg-yellow-50 lg:hover:bg-yellow-50'
